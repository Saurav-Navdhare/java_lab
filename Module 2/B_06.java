public class B_06 {
    public static void main(String[] args) {
        ...
        System.out.println(String.format("Difference using Instance Method: %.2f", p1.getDistanceFromInstance(p2)));
        System.out.println(String.format("Difference using Static Method: %.2f", Point.getDistance(p1, p2)));
